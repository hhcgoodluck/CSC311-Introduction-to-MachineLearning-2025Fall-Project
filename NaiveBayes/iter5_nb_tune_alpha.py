...
def main():
    ...
    # build structured features (ratings + multi-select)
    ...
    suboptimal_tasks_encoded = mlb_subopt.fit_transform(suboptimal_tasks_lists)  # (n_samples, 8)
    ...
    # hyperparameter search for alpha (Laplace smoothing)
